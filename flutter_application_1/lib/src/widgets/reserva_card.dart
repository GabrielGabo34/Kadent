  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ListTile(
          ...
          subtitle: Text(model.fieldsProto!.mensaje!.stringValue!.toString()),
          trailing: Text(model.fieldsProto!.paciente!.mapValue!.fields!.datosP!
              .mapValue!.fields!.nombre!.stringValue!
              .toString())),
    );
  }
}
